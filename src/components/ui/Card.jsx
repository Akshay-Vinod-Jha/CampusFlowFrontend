...
const Card = ({ 
  ...
  const baseStyles = 'card bg-white rounded-lg shadow-soft border border-neutral-200';
  const hoverStyles = hover ? 'card-hover hover:shadow-soft-md transition-shadow duration-200' : '';
